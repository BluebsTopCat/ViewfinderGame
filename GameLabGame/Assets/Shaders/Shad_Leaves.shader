	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float4 transform38_g142 = mul(GetWorldToObjectMatrix(),float4( WindDir , 0.0 ));
				float4 WindDir7_g142 = transform38_g142;
				float4 normalizeResult25_g142 = normalize( WindDir7_g142 );
				float4 break22_g142 = normalizeResult25_g142;
				float2 appendResult29_g142 = (float2(break22_g142.x , break22_g142.y));
				float dotResult27_g142 = dot( appendResult29_g142 , float2( 1,0 ) );
				...
				float WindDirOffset71_g142 = 0.0;
				float mulTime57_g142 = _TimeParameters.x * ( Magnitude41_g142 + WindDirOffset71_g142 );
						 ...
						 ) : SV_Target
			{
				...
				float3 hsvTorgb16_g191 = RGBToHSV( tex2DNode89.rgb );
				float3 objToWorld7_g191 = mul( GetObjectToWorldMatrix(), float4( input.ase_texcoord7.xyz, 1 ) ).xyz;
				float3 lerpResult9_g191 = lerp( WorldPosition , objToWorld7_g191 , 0.0);
				float3 temp_output_33_0_g191 = ( lerpResult9_g191 / 10.0 );
				float simplePerlin3D25_g191 = snoise( temp_output_33_0_g191 );
				float3 break34_g191 = _Variation;
				float3 temp_output_21_0_g191 = ( temp_output_33_0_g191 + float3( 100,100,100 ) );
				...
				float3 Color = lerpResult12_g143.rgb;
