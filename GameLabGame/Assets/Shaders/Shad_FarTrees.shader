...
Shader "FarTrees"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 PerturbNormal107_g235( float3 surf_pos, float3 surf_norm, float height, float scale )
			{
			...
			half4 CalculateShadowMask216_g255(  )
			{
						 ...
						 ) : SV_Target
			{
				...
				float3 worldPosValue184_g255 = WorldPosition;
				float3 WorldPosition164_g255 = worldPosValue184_g255;
				float4 ase_positionSSNorm = ScreenPos / ScreenPos.w;
				ase_positionSSNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_positionSSNorm.z : ase_positionSSNorm.z * 0.5 + 0.5;
				float2 ScreenUV183_g255 = (ase_positionSSNorm).xy;
				float2 ScreenUV164_g255 = ScreenUV183_g255;
				float3 surf_pos107_g235 = WorldPosition;
				float3 ase_normalWS = input.ase_texcoord8.xyz;
				float3 surf_norm107_g235 = ase_normalWS;
				float2 uv_Normal = input.ase_texcoord6.xy * _Normal_ST.xy + _Normal_ST.zw;
				float height107_g235 = tex2D( _Normal, uv_Normal ).rgb.x;
				float scale107_g235 = 100.0;
				float3 localPerturbNormal107_g235 = PerturbNormal107_g235( surf_pos107_g235 , surf_norm107_g235 , height107_g235 , scale107_g235 );
				...
				float3 worldToTangentDir42_g235 = mul( ase_worldToTangent, localPerturbNormal107_g235 );
				float3 temp_output_36_0_g254 = worldToTangentDir42_g235;
				float3 tanToWorld0 = float3( ase_tangentWS.x, ase_bitangentWS.x, ase_normalWS.x );
				float3 tanToWorld1 = float3( ase_tangentWS.y, ase_bitangentWS.y, ase_normalWS.y );
				float3 tanToWorld2 = float3( ase_tangentWS.z, ase_bitangentWS.z, ase_normalWS.z );
				float3 tanNormal12_g255 = temp_output_36_0_g254;
				float3 worldNormal12_g255 = normalize( float3( dot( tanToWorld0, tanNormal12_g255 ), dot( tanToWorld1, tanNormal12_g255 ), dot( tanToWorld2, tanNormal12_g255 ) ) );
				float3 worldNormalValue185_g255 = worldNormal12_g255;
				float3 WorldNormal164_g255 = worldNormalValue185_g255;
				float3 temp_output_15_0_g255 = WorldViewDirection;
				float3 WorldView164_g255 = temp_output_15_0_g255;
				float3 temp_output_14_0_g255 = float3( 1,1,1 );
				float3 SpecColor164_g255 = temp_output_14_0_g255;
				float temp_output_18_0_g255 = 0.125;
				float Smoothness164_g255 = temp_output_18_0_g255;
				half4 localCalculateShadowMask216_g255 = CalculateShadowMask216_g255();
				float4 shadowMaskValue182_g255 = localCalculateShadowMask216_g255;
				float4 ShadowMask164_g255 = shadowMaskValue182_g255;
				float3 localAdditionalLightsSpecularMask14x164_g255 = AdditionalLightsSpecularMask14x( WorldPosition164_g255 , ScreenUV164_g255 , WorldNormal164_g255 , WorldView164_g255 , SpecColor164_g255 , Smoothness164_g255 , ShadowMask164_g255 );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b ) + 1e-7;
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float ase_lightAtten = 0;
				Light ase_mainLight = GetMainLight( ShadowCoords );
				ase_lightAtten = ase_mainLight.distanceAttenuation * ase_mainLight.shadowAttenuation;
				float3 tanNormal33_g254 = temp_output_36_0_g254;
				float3 worldNormal33_g254 = float3( dot( tanToWorld0, tanNormal33_g254 ), dot( tanToWorld1, tanNormal33_g254 ), dot( tanToWorld2, tanNormal33_g254 ) );
				float dotResult31_g254 = dot( _MainLightPosition.xyz , worldNormal33_g254 );
				float smoothstepResult38_g254 = smoothstep( 0.1 , 0.9 , dotResult31_g254);
				float3 temp_output_12_0_g254 = ( ase_lightColor.rgb * ase_lightColor.a * ase_lightAtten * smoothstepResult38_g254 );
				float3 clampResult14_g254 = clamp( temp_output_12_0_g254 , float3( 0,0,0 ) , float3( 1,1,1 ) );
				float4 lerpResult8_g254 = lerp( ( Sky_Top * Sky_Bot ) , float4( temp_output_12_0_g254 , 0.0 ) , float4( clampResult14_g254 , 0.0 ));
				float4 blendOpSrc15_g254 = ( _Tint * float4( hsvTorgb15_g191 , 0.0 ) );
				float4 blendOpDest15_g254 = ( float4( localAdditionalLightsSpecularMask14x164_g255 , 0.0 ) + lerpResult8_g254 );
				...
				float4 lerpResult12_g143 = lerp( ( saturate(  (( blendOpSrc15_g254 > 0.5 ) ? ( 1.0 - ( 1.0 - 2.0 * ( blendOpSrc15_g254 - 0.5 ) ) * ( 1.0 - blendOpDest15_g254 ) ) : ( 2.0 * blendOpSrc15_g254 * blendOpDest15_g254 ) ) )) , Sky_Bot , clampResult13_g143);
				...
				float dotResult330 = dot( ase_viewDirOS , input.ase_normal );
				float dotResult334 = dot( ase_viewDirOS , ( input.ase_normal * float3( -1,-1,-1 ) ) );
				float Transparency182 = tex2DNode89.a;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult12_g143.rgb;
				float Alpha = ( pow( max( dotResult330 , dotResult334 ) , 3.0 ) * Transparency182 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( pow( max( dotResult330 , dotResult334 ) , 3.0 ) * Transparency182 );
...
Node;AmplifyShaderEditor.NormalVertexDataNode;332;2896,-576;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;331;2912,-720;Inherit;False;Object;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;336;3184,-576;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;-1,-1,-1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.DotProductOpNode;330;3344,-688;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;334;3360,-608;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;306;3312,-256;Inherit;True;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;311;3200,-384;Inherit;False;Property;_Billboarding;Billboarding;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;182;1728,-320;Inherit;False;Transparency;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;333;3520,-656;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;337;3600,-576;Inherit;False;182;Transparency;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;343;3632,-688;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;3;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;244;1536,-416;Inherit;False;Property;_Variation;Variation;4;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;178;3136,-464;Inherit;False;Property;_TransparencyCutoff;Transparency Cutoff;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;338;3792,-688;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;241;3328,-880;Inherit;False;CustomFog;-1;;143;b4e3a234c6bbe774b9ca2792a80812c4;0;2;1;COLOR;0,0,0,0;False;20;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;342;2304,-640;Inherit;True;Property;_Normal;Normal;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode;348;2592,-656;Inherit;False;Normal From Height;-1;;235;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;100;False;2;FLOAT3;40;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;354;3040,-864;Inherit;False;Farlighting;-1;;254;038b1eeeef19bbf4f8a4be48d9de5319;0;2;36;FLOAT3;0,0,0;False;17;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;21;4016,-720;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;FarTrees;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;9;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;25;Surface;0;0;  Blend;0;0;Two Sided;0;638527949307706314;Alpha Clipping;1;0;  Use Shadow Threshold;0;638775696195700499;Forward Only;0;0;Cast Shadows;1;0;Receive Shadows;1;638528850798868472;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;638774792634575293;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;0;638528860966675641;0;10;False;True;True;True;False;False;True;True;True;False;False;;False;0
...
WireConnection;241;1;354;0
WireConnection;348;20;342;5
WireConnection;354;36;348;40
WireConnection;354;17;218;0
WireConnection;21;2;241;0
WireConnection;21;3;338;0
WireConnection;21;4;178;0
WireConnection;21;5;295;0
ASEEND*/
//CHKSM=F6113E12B03E9190A2D954F5A495D01B9E1AA5DD